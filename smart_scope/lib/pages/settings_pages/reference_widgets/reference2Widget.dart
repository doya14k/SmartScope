...
class Reference2 extends StatefulWidget {
  const Reference2({super.key});

  @override
  State<Reference2> createState() => _Reference2State();
}

class _Reference2State extends State<Reference2> {
  ...
  void updateRef2_VperDiv(double delta, BuildContext context) {
    setState(() {
      final referenceChanges = Provider.of<ReferenceChanges>(
        context,
        listen: false,
      );
      referenceChanges.incrementVoltageValueperDivision_Ref2(-delta / 100);
      print('Delta ${delta / 100}');
      print('appState.ch1 ${referenceChanges.Ref2uVperDivision}');
                ...
                children: [
                  PopupMenuButton(
                    ...
                    onSelected: (selectedIndex) {
                      setState(() {
                        print(selectedIndex);
                        selectedReference2Graph = selectedIndex;
                      });
                    },
                  ),
                  OutlinedButton(
                    ...
                    onPressed: () {
                      setState(() {
                        ...
                        print(ref.Ref2IsActive);
                        // Convert channel plot data to ref data
                        ref.saveReference2Data(
                          usb.dataChannelLists[selectedReference2Graph],
                          (selectedReference2Graph == 0)
                    ...
                    onPressed: () {
                      setState(() {
                        ...
                        ref.saveReference2Data(
                          ...
                          0,
                          0,
                          ref.minGraphVoltageValueRef2,
                          ref.maxGraphVoltageValueRef2,
                        );
                      });
                    },
                    child: AutoSizeText(
                              ...
                              TextEditingValue(
                                text:
                                    Provider.of<ReferenceChanges>(
                                      context,
                                      listen: false,
                                    ).voltageValueTextperDivision_Ref2,
                              ),
                            ),
                            ...
                            onSubmitted: (inputText) {
                              setState(() {
                                Provider.of<ReferenceChanges>(
                                  context,
                                  listen: false,
                                ).convertVoltageText2Value_perDivision_Ref2(
                                  inputText,
                                );
                                print(inputText);
                              });
                                ...
                                child: Slider(
                                  ...
                                  onChanged: (double value) {
                                    ...
                                    Provider.of<ReferenceChanges>(
                                      context,
                                      listen: false,
                                    ).updateSliderValue_Ref2(transformedValue);
                                  },
                                ),
                              ),
                            ),
                                      ...
                                      TextEditingValue(
                                        text:
                                            Provider.of<ReferenceChanges>(
                                              context,
                                              listen: false,
                                            ).triggerVerticalOffsetValue2Text_Ref2,
                                      ),
                                    ),
                                    style: TextStyle(fontSize: 14),
                                    obscureText: false,
                                    ...
                                    onSubmitted: (inputText) {
                                      setState(() {
                                        Provider.of<ReferenceChanges>(
                                          context,
                                          listen: false,
                                        ).convertTriggerVerticalOffsetText2Value_Ref2(
                                          inputText,
                                        );
                                        print(inputText);
                                      });
                                        ...
                                        if (event is PointerScrollEvent) {
                                          setState(() {
                                            Provider.of<ReferenceChanges>(
                                              context,
                                              listen: false,
                                            ).incrementRef2VerticalOffset(
                                              -event.scrollDelta.dy / 100,
                                            );
                                            print(
                                              '${Provider.of<ReferenceChanges>(context, listen: false).Ref2Offset}',
                                            );
                                          });
                                        }
                                      },
                                        ...
                                        child: Slider(
                                          ...
                                          onChanged: (double value) {
                                            setState(() {
                                              ...
                                              print(
                                                'Offset slide: ${(Provider.of<ReferenceChanges>(context, listen: false).Ref2Offset)}',
                                              );
                                            });
                                          },
                                        ),
